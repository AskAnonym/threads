  ...
  return (
    <div>
      ...
      <p>
        ...
        our website. By accessing or using our website, you agree to comply with
      ...
      <ul>
        <li>
          ...
          the website. When creating an account, you agree to provide accurate
      ...
      <p>
        ...
        software, is the property of Moryeti.com or its licensors and is
        protected by intellectual property laws. You may not reproduce,
        distribute, modify, or create derivative works of any content without
        our prior written consent.
      </p>

      <h2>5. Third-Party Services</h2>
      <p>
        Our website may use third-party services such as Clerk for
        authentication, MongoDB for database management, and Google Analytics
        for tracking and analyzing website usage. Your use of these third-party
        services is subject to their respective terms and conditions and privacy
        policies.
      </p>

      <h2>6. Limitation of Liability</h2>
      <p>
        Moryeti.com shall not be liable for any direct, indirect, incidental,
        special, or consequential damages arising out of your use of the
        website. We do not warrant that the website will be uninterrupted,
        error-free, or free of viruses or other harmful components.
      </p>

      <h2>7. Indemnification</h2>
      <p>
        You agree to indemnify, defend, and hold harmless Moryeti.com and its
